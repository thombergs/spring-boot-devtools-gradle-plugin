...
class MultiModuleTests {
    ...
    fun defaultConfiguration() {
        ...
        files.addPropertiesSourceFile("$WORK_DIR/app/src/main/resources/test.properties")
        files.expectTargetFile("$WORK_DIR/app/build/resources/main/test.properties")
        ...
        files.addPropertiesSourceFile("$WORK_DIR/module1/src/main/resources/test.properties")
        files.expectTargetFile("$WORK_DIR/app/build/resources/main/test.properties")
        ...
        files.addPropertiesSourceFile("$WORK_DIR/module2/src/main/resources/test.properties")
        files.expectTargetFile("$WORK_DIR/app/build/resources/main/test.properties")
    ...
    fun customConfiguration() {
        ...
        assertThat(result.task(":app:restart")).hasAnyOutcome(TaskOutcome.SUCCESS)
        assertThat(result.task(":module1:customCompileJava")).hasAnyOutcome(TaskOutcome.SUCCESS, TaskOutcome.UP_TO_DATE)
